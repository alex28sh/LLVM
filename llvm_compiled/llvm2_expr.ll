...
define i64 @fact(i64 %a_ARG, i64 %b_ARG) {
entry:
...
then:                                             ; preds = %body
  ...
  %modtmp = srem i64 %a_loaded7, %b_loaded8
  store i64 %modtmp, ptr %a, align 4
  br label %ifcont

else:                                             ; preds = %body
  %b_loaded9 = load i64, ptr %b, align 4
  %a_loaded10 = load i64, ptr %a, align 4
  %modtmp11 = srem i64 %b_loaded9, %a_loaded10
  store i64 %modtmp11, ptr %b, align 4
  br label %ifcont
...
entry:
  ...
  %a_loaded = load i64, ptr %a, align 4
  %b_loaded = load i64, ptr %b, align 4
  %calltmp = call i64 @fact(i64 %a_loaded, i64 %b_loaded)
